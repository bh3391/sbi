...
export default function EditTeacherForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    toast.promise(updateTeacher(teacherData.id, data), {
      ...
      success: (res: any) => {
        // Gunakan :any jika interface backend belum fix
        if (res.success) {
          onClose();
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        ...
        <form
          ...
          className="p-8 space-y-5 max-h-[90vh] overflow-y-auto"
        >
          <div className="flex justify-between items-center mb-2">
            <div>
              ...
              <p className="text-[10px] text-fuchsia-500 uppercase font-bold tracking-widest mt-1 text-left">
                Update Data Tenaga Pengajar
              </p>
            </div>
            <button
              type="button"
          ...
          <div className="flex justify-center py-2">
            <div className="relative">
              ...
              <button
                type="button"
                className="absolute -bottom-2 -right-2 bg-white shadow-md p-1.5 rounded-xl text-cyan-600 border border-slate-100"
              >
                <Camera size={14} />
              </button>
            </div>
