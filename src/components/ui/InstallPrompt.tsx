        ...
        <div className="bg-white rounded-[23px] p-5 shadow-inner">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-[10px] text-slate-500 font-medium">
                Pasang di layar utama untuk akses instan.
              </p>
            </div>
          </div>
          ...
          {isIOS ? (
            ...
            <div className="bg-slate-50 rounded-2xl p-4 space-y-3 border border-slate-100">
              <p className="text-[10px] text-slate-600 font-bold uppercase tracking-tight text-center">
                Instruksi iPhone:
              </p>
              <div className="flex items-center gap-3 text-[11px] text-slate-700">
                ...
                <span>
                  Klik ikon <b>'Share'</b> di bar bawah Safari
                </span>
              </div>
              <div className="flex items-center gap-3 text-[11px] text-slate-700">
                <div className="bg-white p-1.5 rounded-lg shadow-sm border">
