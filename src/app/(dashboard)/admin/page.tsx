...
import { Users, MapPin, ChevronRight,Calendar, Clock, ArrowRight, HatGlasses, CurrencyIcon, ArchiveIcon, Settings2Icon, ChartAreaIcon } from "lucide-react";
      ...
      <div className="grid grid-cols-3 gap-2 px-2">
        {menus.map((menu, i) => (
          ...
          >
            ...
            <div className={`pb-1 h-10 w-10 rounded-2xl bg-gradient-to-br ${menu.color} flex items-center justify-center text-white shadow-lg shadow-inherit/20`}>
