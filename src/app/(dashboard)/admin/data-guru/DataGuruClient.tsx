      ...
      <div className="grid grid-cols-1 gap-1 px-1">
        {filtered.length > 0 ? (
          filtered.map((teacher: any) => (
            <div key={teacher.id} className="bg-gradient-to-r from-cyan-50 to-white  p-1 rounded-lg border border-cyan-100 shadow-sm flex items-center justify-between hover:border-fuchsia-200 transition-all">
