      ...
      <div className="grid grid-cols-2 gap-3">
        {menus.map((menu, i) => (
          ...
          >
            ...
            <div
              className={`absolute -right-2 -top-2 h-12 w-12 bg-gradient-to-br ${menu.color} opacity-[0.03] rounded-full blur-lg group-hover:opacity-10 transition-opacity`}
            />

            <div
              className={`h-9 w-9 rounded-lg bg-gradient-to-br ${menu.color} flex items-center justify-center shadow-md shadow-slate-200 mb-3 text-white`}
            >
              {menu.icon}
            </div>
