...
export default function PendaftaranClient({
  ...
  const totalBiaya =
    (selectedPackage?.price || 0) + (selectedAddOn?.price || 0) + REG_FEE;
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!selectedPackage && !selectedAddOn) {
      return toast.error("Pilihan Belum Lengkap", {
        description:
          "Silakan pilih Paket Utama atau Program Add-on terlebih dahulu.",
      });
    }
    ...
    toast.promise(registerStudentPublic(formData), {
      // Langsung kirim formData agar lebih aman
    ...
    return (
      <div className="flex min-h-[90vh] flex-col items-center justify-center p-6 text-center">
        ...
        >
          ...
          <h1 className="mt-8 text-xl font-black tracking-tight text-slate-900">
            Pendaftaran Terkirim!
          </h1>
          <p className="mt-3 text-xs leading-relaxed text-slate-500 max-w-[250px] mx-auto">
            Data Anda telah masuk ke sistem. Mohon tunggu pesan konfirmasi dari
            admin kami via WhatsApp.
          </p>
          <button
            onClick={() => (window.location.href = "/")}
            className="mt-8 text-[10px] font-black uppercase tracking-widest text-cyan-600 border-b-2 border-cyan-100 pb-1"
          >
            Kembali Ke Beranda
          </button>
        </motion.div>
    ...
    <div className="mx-auto max-w-lg bg-gradient-to-br from-cyan-50 to-fuchsia-200 px-5 py-8 sm:py-12">
      ...
      <header className="mb-12 flex flex-col items-center text-center">
        ...
        <p className="mt-2 text-[10px] font-bold uppercase tracking-widest text-slate-500">
          Isi data diri untuk memulai perjalanan belajar bersama BIMBEls
        </p>
      </header>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="relative">
                <input
                  ...
                  className="peer w-full border-b-2 border-slate-100 bg-transparent py-3 text-xs font-bold text-slate-800 outline-none transition-all focus:border-cyan-500"
                />
                <span className="absolute -top-3 left-0 text-[9px] font-black text-cyan-600 uppercase transition-all peer-placeholder-shown:opacity-0 peer-focus:opacity-100">
                  Nama Lengkap
                </span>
              </div>
          ...
          <div className="bg-white rounded-[24px] p-6 shadow-sm border border-slate-100 space-y-5">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="space-y-1">
                ...
                <select
                  name="locationId"
                  className="w-full rounded-xl bg-slate-50 p-3.5 text-xs font-bold text-slate-700 outline-none focus:ring-2 focus:ring-fuchsia-500/20 appearance-none border border-transparent focus:border-fuchsia-100"
                >
            ...
            <div className="grid grid-cols-1  gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[8px] text-slate-400 italic px-1">
                  *Pilih add-on jika siswa mengambil sesi tambahan di luar paket
                  utama.
                </p>
              </div>
            </div>
        ...
        <div className="px-2 py-4">
          <label
            className={`flex items-start gap-3 cursor-pointer group ${!hasRead ? "opacity-50 cursor-not-allowed" : ""}`}
          >
            <div className="relative mt-0.5">
              ...
              />
              <ShieldCheck
                className={`absolute inset-0 text-white transition-transform ${agreed ? "scale-75" : "scale-0"}`}
              />
            </div>
            <p className="text-[10px] leading-relaxed text-slate-400 font-medium">
              ...
              yang berlaku serta memberikan izin penggunaan data untuk keperluan
              ...
              <div className="text-[11px] text-slate-500 leading-relaxed space-y-4 max-h-[70vh] overflow-y-auto pr-4 custom-scrollbar">
                <section>
                  <h4 className="font-bold text-slate-700 mb-1">
                    1. Pembayaran & Status Keaktifan
                  </h4>
                  <p>
                    • SPP wajib dibayarkan sebelum dimulainya pembelajaran atau
                    di awal bulan.
                  </p>
                  <p>
                    • Siswa yang menunda pembayaran SPP akan dinonaktifkan
                    secara otomatis, dan kuota belajar akan dialihkan ke siswa
                    baru.
                  </p>
                  <p>
                    • Siswa yang tidak aktif/off dalam kurun waktu 3 bulan akan
                    dikenakan biaya pendaftaran ulang saat bergabung kembali.
                  </p>
                </section>

                <section>
                  <h4 className="font-bold text-slate-700 mb-1">
                    2. Kehadiran & Kuota Belajar
                  </h4>
                  <p>
                    • Siswa wajib mengikuti jadwal yang telah disepakati.
                    Ketidakhadiran tanpa konfirmasi dianggap tetap masuk (kuota
                    1x pertemuan hangus).
                  </p>
                  <p>
                    • Pembelajaran efektif berlangsung selama 4 minggu. Minggu
                    ke-5 adalah minggu tidak efektif/libur.
                  </p>
                </section>

                <section>
                  <h4 className="font-bold text-slate-700 mb-1">
                    3. Kebijakan Jadwal Pengganti
                  </h4>
                  <p>
                    • Orang tua wajib mengonfirmasi ketidakhadiran maksimal
                    **H-1** untuk mendapatkan jadwal pengganti.
                  </p>
                  <p>
                    • Jadwal pengganti bersifat terbatas dan tidak pasti karena
                    diambil dari kekosongan kuota siswa lain. Orang tua
                    disarankan aktif mengonfirmasi jadwal pengganti yang
                    ditawarkan.
                  </p>
                  <p>
                    • Jika dalam 1 bulan siswa berhalangan berturut-turut dan
                    tidak mendapatkan/mengambil jadwal pengganti yang
                    ditawarkan, maka kuota belajar dipastikan hangus.
                  </p>
                  <p>
                    • Jadwal pengganti yang telah dikonfirmasi tidak dapat
                    dijadwalkan ulang (hangus jika tidak hadir).
                  </p>
                </section>

                <section className="bg-cyan-50 p-3 rounded-lg border border-cyan-100 italic">
                  Aturan ini bertujuan menjaga kualitas belajar mengajar dengan
                  rasio guru-siswa yang ideal (1:3 untuk Calistung/Preschool,
                  dan 1:3-5 untuk Matematika/Inggris).
                </section>
              </div>
            </div>
