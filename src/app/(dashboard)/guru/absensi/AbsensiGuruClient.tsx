...
import { Search, Plus, ChevronRight, UserCircle, Calendar } from "lucide-react";
                  ...
                  filteredTeachers.map((teacher: any) => {
                    ...
                    const getStatusStyle = (status: string) => {
                      switch (status) {
                        ...
                        default:
                          return "bg-red-50 text-red-400 border-slate-200";
                      }
                    };
                      ...
                      >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                <span
                                  className={`text-[8px] font-black px-1.5 py-0.5 rounded uppercase tracking-tighter border ${getStatusStyle(status)}`}
                                >
                                  {status}
                                </span>
                                <span
                                  className={`text-[8px] font-black px-1.5 py-0.5 rounded uppercase tracking-tighter border ${isLate ? "bg-red-50 text-red-600 border-red-100" : "bg-green-50 text-green-600 border-green-100"}`}
                                >
                                  {isLate ? "Late" : "On Time"}
                                </span>
                              </div>
                        ...
                        <td className="px-4 py-3 text-right">
                          <div className="flex justify-end">
                            <ChevronRight
                              size={16}
                              className="text-slate-300 group-hover:text-cyan-500 transition-transform group-hover:translate-x-1"
                            />
                          </div>
                        </td>
                      </tr>
