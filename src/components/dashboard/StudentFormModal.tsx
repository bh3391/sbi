    ...
    <div className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center">
      ...
      >
        ...
        <div className="p-6 border-b border-slate-50 flex justify-between items-center bg-gradient-to-r from-white to-slate-50">
          ...
          <button
            onClick={onClose}
            className="p-2 bg-slate-100 text-slate-400 rounded-full hover:bg-rose-50 hover:text-rose-500 transition-colors"
          >
            <X size={20} />
          </button>
        </div>
        ...
        >
          ...
          {/* Section: Akademik */}
          <div className="space-y-4">
            <label className="text-[10px] font-black text-fuchsia-600 uppercase tracking-widest ml-1">
              Pengaturan Belajar
            </label>
            <div className="space-y-3">
              <div className="relative">
                ...
                <select
                  required
                  className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-none rounded-2xl text-sm font-bold appearance-none outline-none focus:ring-2 focus:ring-fuchsia-500"
