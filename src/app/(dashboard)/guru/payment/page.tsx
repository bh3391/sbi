...
export default async function SelectLocationPaymentPage() {
  ...
  const totalAllStudents = locations.reduce(
    (acc, loc) => acc + loc._count.students,
    0,
  );

  return (
    <div className="max-w-5xl mt-3 mx-auto">
      <DashboardHeader userId={userId} title="Payments" />
      ...
      <div className="grid grid-cols-2 mt-2 gap-4 p-1">
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <div>
              <h3 className="text-md font-bold text-white">Semua Lokasi</h3>
              <p className="text-[10px] text-slate-400 font-medium">
                Rekapitulasi Seluruh Cabang
              </p>
            </div>
          ...
          >
            <div className="flex flex-col h-full">
              ...
              <div className="mt-2 pt-2 border-t border-slate-50 flex items-center justify-between">
                <span className="text-[8px] font-bold text-cyan-700 uppercase">
                  Total Siswa
                </span>
